  ...
  return (
    <Grid container spacing={0} style={{ marginTop: marginTop }}>
      <Grid item xs={12} sm={6}>
        <Image
          src={
            "https://sincerelyjules.com/wp-content/uploads/2022/09/Sincerely-jules-sezane-dress-loafers-look-1-1000x1500.jpg"
          }
      ...
      <Grid item xs={12} sm={6}>
        ...
        >
          ...
          >
            ...
            dress, take a look at this outfit for inspo!
          </Typography>
          <HorizontalList />
          <CustomButton
